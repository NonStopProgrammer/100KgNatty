...
import { Send, Phone, Mail, MapPin, Instagram, Youtube, Twitter, CheckCircle } from 'lucide-react';
          ...
          <div className="lg:col-span-3">
            <Reveal delay={0.2} width="100%">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2 group">
                    <label htmlFor="phone" className="text-sm font-bold text-neutral-400 uppercase tracking-wide group-focus-within:text-lime-500 transition-colors">Phone</label>
                    <input
                      type="tel"
                      id="phone"
                      name="phone"
                ...
                <button
                  ...
                  className={`w-full py-4 font-black text-lg uppercase italic tracking-wider skew-x-[-12deg] transition-all flex items-center justify-center gap-2 group overflow-hidden relative ${
                    submitted 
              ...
              <div className="bg-neutral-900/50 border border-neutral-800 p-8 rounded-xl backdrop-blur-sm hover:border-lime-500/30 transition-colors">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4 group cursor-pointer">
                    ...
                    <div>
                      <p className="text-xs text-neutral-500 font-bold uppercase tracking-wider mb-1 group-hover:text-lime-500 transition-colors">Phone</p>
                      <p className="text-white font-medium hover:text-lime-500 transition-colors">+1 98765 43210</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 group cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-white font-medium hover:text-lime-500 transition-colors">coach@aravindhfitness.com</p>
                    </div>
                  </div>
