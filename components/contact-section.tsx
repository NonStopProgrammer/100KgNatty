      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-balance">
            Let&apos;s plan your <span className="text-primary">next phase</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty leading-relaxed">
            Share your goals and schedule. I&apos;ll reply within one business day with a plan that fits your time,
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      onChange={handleChange}
                      placeholder="Share your goals, timelines, and any injuries or equipment notes..."
                      rows={6}
                      required
                      className="transition-all focus:scale-[1.02]"
                    />
              ...
              <CardContent className="p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">hello@peakform.in</p>
                  </div>
                </div>
              </CardContent>
            </Card>
